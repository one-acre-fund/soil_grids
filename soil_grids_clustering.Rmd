...
westernMap <- intersect(keBoundaries, siteReproject)

# from Name 1
westernAreas <- c("Bungoma", "Busia", "Homa Bay", "Kakamega", "Kericho", "Kisii", "Kisumu", "Migori", "Nyamira", "Siaya", "Vihiga", "Kiambu", "Bomet", "Meru", "Nakuru", "Nandi", "Tharaka-Nithi", "Narok", "Nyeri", "Embu", "Kirinyaga", "Uasin Gishu")
