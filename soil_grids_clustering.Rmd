...
if(!file.exists(paste(dataDir, "output", "pH_weighted_layer.tif", sep = "/")) | forceUpdate){
  print("tried")
  pHLayer <- sum(stack(addWeights(importRasterAsList(tifFinder("af_PHIHOX_T__M")), weightList)))
...
if(!file.exists(paste(dataDir, "output", "carbon_weighted_layer.tif", sep = "/")) | forceUpdate){
  carbonLayer <- sum(stack(addWeights(importRasterAsList(tifFinder("af_ORCDRC_T__M")), weightList)))
...
if(!file.exists(paste(dataDir, "output", "texture_weighted_layer.tif", sep = "/")) | forceUpdate){
  textureLayer <- sum(stack(addWeights(importRasterAsList(tifFinder("af_TEXMHT_T__M")), weightList)))
...
if(!file.exists(paste(dataDir, "output", "sand_weighted_layer.tif", sep = "/")) | forceUpdate){
  sandLayer <- sum(stack(addWeights(importRasterAsList(tifFinder("af_SNDPPT_T__M")), weightList)))
...
if(!file.exists(paste(dataDir, "output", "silt_weighted_layer.tif", sep = "/")) | forceUpdate){
  siltLayer <- sum(stack(addWeights(importRasterAsList(tifFinder("af_SLTPPT_T__M")), weightList)))
...
if(!file.exists(paste(dataDir, "output", "clay_weighted_layer.tif", sep = "/")) | forceUpdate){
  clayLayer <- sum(stack(addWeights(importRasterAsList(tifFinder("af_CLYPPT_T__M")), weightList)))
...
if(!file.exists(paste(dataDir, "output", "cec_weighted_layer.tif", sep = "/")) | forceUpdate){
  cecLayer <- sum(stack(addWeights(importRasterAsList(tifFinder("af_CEC_T__M")), weightList)))
...
nitrogenLayer <- importRasterAsList(tifFinder("af250m_nutrient_n_m_agg30cm.tif"))[[1]]
```
...
```{r}
soilCrop <- crop(soilStack, extent(westernMap))

soilMask <- mask(soilCrop, westernMap)
