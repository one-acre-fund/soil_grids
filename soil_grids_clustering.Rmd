...
```{r eval=FALSE, include=FALSE}
#ph
# pHLayer <- mean(importRasterAsList(tifFinder("af_PHIHOX_T__M_sd1"))[[1]] * firstWeight, importRasterAsList(tifFinder("af_PHIHOX_T__M_sd2"))[[1]] * secondWeight, importRasterAsList(tifFinder("af_PHIHOX_T__M_sd3"))[[1]] * thirdWeight)

forceUpdate <- FALSE

# ph but with functions
if(!file.exists(paste(dataDir, "output", "pH_weighted_layer.tif", sep = "/") | forceUpdate)){
  pHLayer <- mean(stack(addWeights(importRasterAsList(tifFinder("af_PHIHOX_T__M")))))
...
if(!file.exists(paste(dataDir, "output", "carbon_weighted_layer.tif", sep = "/") | forceUpdate)){
  carbonLayer <- mean(stack(addWeights(importRasterAsList(tifFinder("af_ORCDRC_T__M")))))
...
if(!file.exists(paste(dataDir, "output", "texture_weighted_layer.tif", sep = "/") | forceUpdate)){
  textureLayer <- mean(stack(addWeights(importRasterAsList(tifFinder("af_TEXMHT_T__M")))))
...
if(!file.exists(paste(dataDir, "output", "sand_weighted_layer.tif", sep = "/") | forceUpdate)){
  sandLayer <- mean(stack(addWeights(importRasterAsList(tifFinder("af_SNDPPT_T__M")))))
...
if(!file.exists(paste(dataDir, "output", "silt_weighted_layer.tif", sep = "/") | forceUpdate)){
  siltLayer <- mean(stack(addWeights(importRasterAsList(tifFinder("af_SLTPPT_T__M")))))
...
if(!file.exists(paste(dataDir, "output", "clay_weighted_layer.tif", sep = "/") | forceUpdate)){
  clayLayer <- mean(stack(addWeights(importRasterAsList(tifFinder("af_CLYPPT_T__M")))))
...
if(!file.exists(paste(dataDir, "output", "cec_weighted_layer.tif", sep = "/") | forceUpdate)){
  cecLayer <- mean(stack(addWeights(importRasterAsList(tifFinder("af_CEC_T__M")))))
...
```{r}
test <- combineRasters(importRasterAsList(testInput), weightList)
nlayers(test)
